...
// Equasions
// ========================================================
   SubBytes8bit s00(.x(a00), .y(b00));
   SubBytes8bit s01(.x(a10), .y(b10));
   SubBytes8bit s02(.x(a20), .y(b20));
   SubBytes8bit s03(.x(a30), .y(b30));
...
//  assign b30 = s_box( a30 );
 ...
 SubBytes8bit s04(.x(a01), .y(b01));
 SubBytes8bit s05(.x(a11), .y(b11));
 SubBytes8bit s06(.x(a21), .y(b21));
 SubBytes8bit s07(.x(a31), .y(b31));
...
SubBytes8bit s08(.x(a02), .y(b02));
SubBytes8bit s09(.x(a12), .y(b12));
SubBytes8bit s10(.x(a22), .y(b22));
SubBytes8bit s11(.x(a32), .y(b32));
...
SubBytes8bit s12(.x(a03), .y(b03));
SubBytes8bit s13(.x(a13), .y(b13));
SubBytes8bit s14(.x(a23), .y(b23));
SubBytes8bit s15(.x(a33), .y(b33));
