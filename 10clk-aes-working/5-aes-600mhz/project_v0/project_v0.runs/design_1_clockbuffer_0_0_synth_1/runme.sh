...
HD_PWD='D:/Onedrive/OneDrive - UNSW/My Onedrive/PhD/Src/New-Delay-Sensor/1LUT-Kria260/project_v0/project_v0.runs/design_1_clockbuffer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clockbuffer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clockbuffer_0_0.tcl
